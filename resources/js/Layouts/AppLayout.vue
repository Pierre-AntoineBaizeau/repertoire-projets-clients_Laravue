<template>
    <div>
        ...
        <div class="min-h-screen bg-gray-100">
            <nav class="bg-white border-b border-gray-700  bg-gray-800">
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                ...
                                <!-- <jet-nav-link :href="route('/projets')" :active="route().current('projets.index')">
                                    Projets
                                </jet-nav-link> -->

                                <jet-nav-link :href="route('projets.index')" :active="route().current('projets.index')">
                                    Projets
                                </jet-nav-link>
